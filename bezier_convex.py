...
# =============================================================================
# AUGMENTATION METHOD: BEZIER CONVEX
# =============================================================================
...
def process_dataset(df, class_col, feature_cols):
    ...
    for c in np.unique(y):
        ...
        # 1. K-Means and Optimal K
        k_opt = find_optimal_k(Xc)
        print(f"Optimal K for Class {c}: {k_opt}")
        
        # Fit K-Means on original data to get labels and scores
        ...
        # Calculate post-augmentation scores
        if len(S) > 0:
...
def main():
    ...
    print("\nRunning BEZIER CONVEX augmentation...")
    try:
        aug_df = process_dataset(df, "class", feature_cols)
        save_path = "augmented_datasets/bezier_convex_augmented.csv"
